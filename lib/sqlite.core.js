...
plugin.exec = function(method, options, success, error) {
  ...
  NativeModules["Sqlcipher"][method](options,success,error);
};
...
SQLiteFactory.prototype.copyDBFile = argsArray(function(args) {
  var errorcb, first, okcb, openargs, readOnly;
  if (args.length < 1) {
    return null;
  }
  ...
  plugin.exec("copyDBFile",openargs, mySuccess, myError);
});
